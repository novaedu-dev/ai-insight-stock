...
export const themes: ThemeData[] = [
  {
    ...
    accentColor: '#06b6d4',
    stocks: ['053080.KQ', '083450.KQ', '267260.KS', '208050.KQ'],
  },
  {
    key: 'robotics',
...
export const stocks: StockData[] = [
  ...
  },
  {
    ...
    isBeginnerFriendly: true,
    tags: ['ESS', '에너지저장', '소형주'],
    entryStrategy: ['42,000원대 분할 매수', '1차 지지선 38,000원'],
    upsideTriggers: ['ESS 사업 실적 개선', '정부 재생에너지 정책', '해외 수주 확대'],
    exitRiskFactors: ['소형주 변동성', '실적 부진', 'ESS 수요 둔화'],
  },
  // ====== 온디바이스 AI·로봇·모빌리티 ======
  {
    ticker: '005380.KS',
